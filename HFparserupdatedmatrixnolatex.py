        ...
        for line in f:
            ...
            if atom in iso:
                ...
                writer.writerow([
                    ...
                    Axx, Ayy, Azz,
                    Axy, Axz, Ayz,
                    eigvals[0], polar_coords[0][0], polar_coords[0][1],
                    eigvals[1], polar_coords[1][0], polar_coords[1][1],
                    eigvals[2], polar_coords[2][0], polar_coords[2][1],
                    a_iso, a_iso_corecorr
                ])
    
    #removes hfdipolarall text file
    os.remove("HFdipolarAll.txt")
